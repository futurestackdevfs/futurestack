...
const tabs: { id: TabId; icon: string; label: string; badge?: string; badgeCls?: string }[] = [
  ...
  { id: "courses", icon: "📚", label: "My Courses", badge: "3", badgeCls: "bg-blue-500/10 text-[#3b82f6] dark:text-[#60a5fa]" },
        ...
        <div className="p-2.5">
          {tabs.map(tab => (
            <button
              ...
              className={`flex items-center gap-2.5 px-2.5 py-[7px] rounded-[6px] w-full text-left text-[11.5px] cursor-pointer transition-all no-underline border-none ${
                activeTab === tab.id
