...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { icon: "👥", label: "My Leads", view: "leads", badgeKey: "leads", badgeColor: { color: "var(--blue)", bg: "var(--blue-d)" } },
      { icon: "📌", label: "Follow-ups", view: "followups", badgeKey: "followups", badgeColor: { color: "var(--amber)", bg: "var(--amber-d)" } },
      { icon: "✅", label: "Converted", view: "converted", badgeKey: "converted", badgeColor: { color: "var(--green)", bg: "var(--green-d)" } },
    ],
  },
  {
    group: "Sales",
  ...
  },
  {
    ...
    items: [
      ...
      { icon: "🎯", label: "Targets", view: "targets" },
    ],
  },
];
