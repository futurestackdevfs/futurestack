...
const PILL_STYLES: Record<string, { bg: string; fg: string }> = {
  ...
  "UPI": { bg: "var(--green-d)", fg: "var(--green)" },
  "Card": { bg: "var(--blue-d)", fg: "var(--blue)" },
  "Net Banking": { bg: "var(--amber-d)", fg: "var(--amber)" },
  "Cash": { bg: "var(--purple-d)", fg: "var(--purple)" },
  "Other": { bg: "var(--panel)", fg: "var(--text3)" },
