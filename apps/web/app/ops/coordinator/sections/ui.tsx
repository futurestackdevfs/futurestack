...
const PILL_STYLES: Record<string, { bg: string; fg: string }> = {
  "New": { bg: "var(--blue-d)", fg: "var(--blue)" },
  "Interested": { bg: "var(--amber-d)", fg: "var(--amber)" },
  "Converted": { bg: "var(--green-d)", fg: "var(--green)" },
  "Dropped": { bg: "var(--red-d)", fg: "var(--red)" },
  "Online": { bg: "var(--blue-d)", fg: "var(--blue)" },
  "Offline": { bg: "var(--purple-d)", fg: "var(--purple)" },
  "Paid": { bg: "var(--green-d)", fg: "var(--green)" },
  "Pending": { bg: "var(--amber-d)", fg: "var(--amber)" },
  "CREATED": { bg: "var(--amber-d)", fg: "var(--amber)" },
  "PAID": { bg: "var(--green-d)", fg: "var(--green)" },
  "FAILED": { bg: "var(--red-d)", fg: "var(--red)" },
  "CANCELLED": { bg: "var(--panel)", fg: "var(--text3)" },
  "EXPIRED": { bg: "var(--panel)", fg: "var(--text3)" },
  "active": { bg: "var(--green-d)", fg: "var(--green)" },
  "inactive": { bg: "var(--panel)", fg: "var(--text3)" },
  "resolved": { bg: "var(--green-d)", fg: "var(--green)" },
  "Falling Behind": { bg: "var(--red-d)", fg: "var(--red)" },
  "On Track": { bg: "var(--green-d)", fg: "var(--green)" },
  "Needs Attention": { bg: "var(--amber-d)", fg: "var(--amber)" },
