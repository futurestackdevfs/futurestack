      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="hidden lg:flex sticky top-0 z-40 w-[210px] shrink-0 bg-white dark:bg-[#111520]
          ...
          <div className="px-2.5 py-0.5">
            ...
            <Link href="/skill-tests" className="flex items-center gap-2 px-2.5 py-[5px] rounded-[5px] text-[#000000] dark:text-[#b0bac9] text-[12.5px] mx-1 hover:bg-[#f4f6fa] dark:hover:bg-[#0b0e14] hover:text-[#000000] dark:hover:text-[#e8eaf0] transition-all no-underline"><span className="text-[13px] shrink-0 w-4 text-center">🎯</span><span className="flex-1">Skill Tests</span></Link>
        ...
        <div className="fixed inset-0 z-50 lg:hidden flex flex-col">
          ...
          <div className="bg-white dark:bg-[#111520] rounded-t-2xl max-h-[75vh] overflow-y-auto px-3 pt-4 pb-8 shadow-[0_-8px_30px_rgba(0,0,0,.12)]">
            ...
            <div className="px-2.5 py-1">
              ...
              <Link href="/skill-tests" onClick={() => setSidebarOpen(false)} className="flex items-center gap-2.5 px-2.5 py-[6px] rounded-[5px] text-[#000000] dark:text-[#b0bac9] text-[13px] mx-1 hover:bg-[#f4f6fa] dark:hover:bg-[#0b0e14] hover:text-[#000000] dark:hover:text-[#e8eaf0] transition-all no-underline"><span className="text-[14px] shrink-0 w-4 text-center">🎯</span><span className="flex-1">Skill Tests</span></Link>
