      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="hidden lg:flex sticky top-0 z-40 w-[210px] shrink-0 bg-white dark:bg-[#111520]
            ...
            {tabs.map(tab => (
              ...
              >
                ...
                {resolveBadge(tab, sectionCtx) && (
                  <span className={`font-['JetBrains_Mono',monospace] text-[7px] font-semibold px-[4px] py-px rounded-[3px] ${tab.badgeCls || ""}`}>{resolveBadge(tab, sectionCtx)}</span>
                )}
              </button>
            ))}
          </div>
          ...
          <div className="px-2.5 py-0.5">
            ...
            <Link href="/courses?trending=1" className="flex items-center gap-2 px-2.5 py-[5px] rounded-[5px] text-[#374151] dark:text-[#b0bac9] text-[10px] mx-1 hover:bg-[#f4f6fa] dark:hover:bg-[#0b0e14] hover:text-[#111827] dark:hover:text-[#e8eaf0] transition-all no-underline"><span className="text-[11px] shrink-0 w-4 text-center">🔥</span><span className="flex-1">Trending</span><span className="font-['JetBrains_Mono',monospace] text-[7px] font-semibold px-[3px] py-px rounded-[3px] bg-green-500/10 text-green-600 dark:text-green-500">New</span></Link>
