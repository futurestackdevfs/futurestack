              ...
              {isAuthenticated && user && (
                <div className="w-[260px] rounded-2xl border border-[var(--border)] bg-[var(--surface)] shadow-2xl overflow-hidden">
                  ...
                  <div className="py-1">
                    ...
                    <Link href="/support" onClick={() => setProfileOpen(false)} className="flex items-center gap-3 px-4 py-2.5 text-[12px] font-medium text-[var(--text)] hover:bg-[var(--bg)] transition-colors">
      ...
      <div className={`fixed top-14 right-0 z-50 w-[260px] h-[calc(100vh-56px)] bg-[var(--surface)] border-l border-[var(--border)] shadow-2xl md:hidden overflow-y-auto transition-transform duration-300 font-[family-name:var(--font-dm-sans)] ${mobileOpen ? "translate-x-0" : "translate-x-full"}`}>
        ...
        {!isLoading && isAuthenticated && user && (
          <div className="px-3 py-1.5">
            ...
            <Link href="/support" onClick={() => setMobileOpen(false)} className="flex items-center gap-2.5 px-2.5 py-1.5 rounded-md text-[12px] font-medium text-[var(--text)] hover:bg-[var(--bg)] transition-colors no-underline">
